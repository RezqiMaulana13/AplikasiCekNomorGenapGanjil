...
public class CekNomor extends javax.swing.JFrame {
     ...
     */
     public CekNomor() {
        initComponents();
        // Tambahkan FocusListener ke jTextField1
    ...
    try {
        ...
        if (number % 2 == 0) {
            jLabel1.setText(number + " adalah angka genap.");
        } else {
            jLabel1.setText(number + " adalah angka ganjil.");
        }
        
        if (isPrime(number)) {
            jLabel1.setText(jLabel1.getText() + " Dan " + number + " adalah bilangan prima.");
        } else {
            jLabel1.setText(jLabel1.getText() + " Dan " + number + " bukan bilangan prima.");
        }
    } catch (NumberFormatException e) {
        // Jika input bukan angka, tampilkan pesan kesalahan
        jLabel1.setText("Input tidak valid. Masukkan angka.");
    }
    }
    private boolean isPrime(int number) {
    if (number <= 1) {
        return false; // Angka 0 dan 1 bukan bilangan prima
    }
